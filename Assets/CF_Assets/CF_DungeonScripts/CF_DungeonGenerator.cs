...
public class CF_DungeonGenerator : MonoBehaviour
{
    ...
    {
        CF_RoomController.instance.LoadRoom("Normal0",0,0); 
        ...
        CF_RoomController.instance.LoadRoom("Normal0",1,-1*itemRoomSpawn);    //to be replaced with item room
        ...
        CF_RoomController.instance.LoadRoom("Normal0",0,-1*bossRoomSpawn);  // to be replaced with boss room spawn
